...
#include "AAMoveToLocationOrActor3D.generated.h"
...
class NAVIGATIONGRID_API UAAMoveToLocationOrActor3D : public UBlueprintAsyncActionBase, public FTickableGameObject
{
	GENERATED_BODY()
	
public:
	UFUNCTION(BlueprintCallable, DisplayName="Async Action Move to Location or Actor 3D" ,meta = (WorldContext = "WorldContext", BlueprintInternalUseOnly = "true"), Category = "Navigation Grid | Async Action")
	static UAAMoveToLocationOrActor3D* MoveToLocationOrActor3D(APawn* WorldContext, FVector Location);
